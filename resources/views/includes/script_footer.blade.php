...
<script src="{{ asset('bootstrap/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js') }}"></script>
<script src="{{ asset('bootstrap/dist/js/sidebarmenu.js') }}"></script>
<!--Custom JavaScript -->
<script src="{{ asset('bootstrap/dist/js/custom.min.js') }}"></script>
<!--This page JavaScript -->
<script src="{{ asset('bootstrap/assets/extra-libs/c3/d3.min.js') }}"></script>
<script src="{{ asset('bootstrap/assets/extra-libs/c3/c3.min.js') }}"></script>
...
<script src="{{ asset('bootstrap/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js') }}"></script>
<script src="{{ asset('bootstrap/assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js') }}"></script>
<script src="{{ asset('bootstrap/dist/js/pages/dashboards/dashboard1.min.js') }}"></script>
